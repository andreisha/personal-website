...
function setLanguage(lang) {
	if (lang === "fr") {
		...
		csTxt = "<b>CENTRALESUPÉLEC (Parcours Centrale Paris)</b><br><br>Après deux années de classes préparatoires MPSI/MP, j’ai intégré l’École Centrale Paris, où j’ai suivi pendant deux ans une formation d’ingénieure généraliste - option informatique.<br>Les cours principaux que j'ai suivis ont été : Systèmes d’information, Développement logiciel, Communications numériques et réseaux, Stratégie et marketing, Éthique et responsabilité, Développement durable.";
		pucTxt = "<b>PONTIFICIA UNIVERSIDADE CATÓLICA DO RIO DE JANEIRO (PUC-Rio)</b><br><br>Pendant un an et demi, j’ai suivi une formation spécialisée en ingénierie informatique (en portugais).<br>Les cours principaux suivis ont été : Concurrence et parallélisme, Bases de données, Systèmes opérationnels, Structures de données, Introduction à la Data Science, Big Data & streaming, Tests et mesures de software.<br>Aussi, j'ai eu le plaisir de recevoir, pendant deux semestres, un prix donné par la PUC-Rio aux élèves avec les meilleurs résultats académiques.<br><br>Pendant mon temps libre, j’ai aussi participé en groupe à:<br>- Un marathon de SQL de 3h (SBBD 2019), obtenant la 2ème place<br>- Un marathon de programmation de 4h (maratona VTEX)";
		// Experiences
		alkuDescription = "<b>E-commerce Developer</b><br>février-juillet 2017, Quito";
		numberlyDescription = "<b>Project Manager</b><br>aout 2017-janvier 2018, Londres";
		pdrDescription = "<b>Data Analyst</b><br>février-juin 2018, Barcelone";
		pucInfoDescription = "<b>Software Developer</b><br>avril-décembre 2019, Rio de Janeiro";
		alkuTxt = "<br><b>ALKUPETS</b><br><i>E-commerce Developer (stage)</i><br><br>ALKU est une start-up sociale basée en Équateur qui produit à la main des jouets recyclés et des traitements naturels pour chiens, le tout en respectant l'environnement et en aidant les communautés locales. <br><br>Avec 4 autres étudiants, nous avons développé une plateforme de e-commerce pour aider l'entreprise à être plus visible, et avons passé 1 mois à Quito pour terminer le projet et formes les équipes sur place.";
		...
		// Interests
		socialTxt = "<b>IMPACT SOCIAL ET VOLONTARIAT </b> <br> <br>Je crois vraiment en l'impact que quelques personnes motivées peuvent avoir dans notre société et en l'importance de petites actions quotidiennes. <br> <br> C’est pourquoi, quand je peux, j'essaie de donner un peu de mon temps dans des projets bénévoles: <br> * Pendant deux ans à l'université, j'ai été présidente de l'association de loi 1901 Centrale Egalité des Chances (devenue OSER) qui oeuvre pour l’ouverture sociale <br> * J'ai aussi donné des cours de mathématiques et d'espagnol pour des jeunes immigrés à Barcelone (2018) et à l'Association Parque Vivo de Rio de Janeiro (2019)";
		...
		pucTxt = "<b>PONTIFICIA UNIVERSIDADE CATÓLICA DO RIO DE JANEIRO (PUC-Rio)</b><br><br>Durante un año y medio, hice un doble diploma en informática (clases en portugués). <br> Las principales disciplinas que hice fueron: Computación concurrente y paralelismo, Bases de datos, Sistemas operativos, Estructuras de datos, Introducción a la Data Sciente, Big Data y streaming, Tests y mediciones de software. <br> Además, tuve el placer de recibir, durante dos semestres, un premio otorgado por la PUC-Río a los estudiantes con los mejores resultados académicos.<br> <br> Durante mi tiempo libre, también participé en grupo a: <br> - Un maratón SQL de 3h (SBBD 2019), obteniendo el 2do lugar <br> - Un maratón de programación de 4h (maratona VTEX)";
		// Experiences
		alkuDescription = "<b>E-commerce Developer</b><br>febrero-julio 2017, Quito";
		numberlyDescription = "<b>Project Manager</b><br>agosto 2017-enero 2018, Londres";
		pdrDescription = "<b>Data Analyst</b><br>febrero-junio 2018, Barcelona";
		pucInfoDescription = "<b>Software Developer</b><br>abril-diciembre 2019, Rio de Janeiro";
		alkuTxt = "<br><b>ALKUPETS</b><br><i>E-commerce Developer (prácticas)</i><br><br>ALKU es una start-up social con sede en Ecuador que produce juguetes reciclados a mano y tratamientos naturales para perros, siempre respetando el medio ambiente y ayudando a las comunidades locales. <br> <br> Con otros 4 estudiantes, desarrollamos una plataforma de e-commerce para ayudar a la empresa a ser más visibles, y pasamos 1 mes en Quito para completar el proyecto y formar a los equipos personalmente.";
		...
		othersTxt = "<b>Otros</b>";
		// Interests
		socialTxt = "<b>IMPACTO SOCIAL Y VOLUNTARIADO </b> <br> <br> Creo realmente que algunas personas motivadas pueden tener un gran impacto en nuestra sociedad, y también en la importancia de pequeñas acciones diarias. <br> <br> Por eso, cuando puedo, trato de dedicar parte de mi tiempo a proyectos de voluntariado: <br> * Durante dos años en la universidad, fui presidenta de la asociación de inclusión social <i> Centrale Égalité des Chances</i> (ahora OSER) <br> * También di clases de matemáticas y español para jóvenes inmigrantes en Barcelona (2018) y en la Asociación Parque Vivo de Rio de Janeiro (2019)";
		runningTxt = "<b>DEPORTES </b> <br> <br> En mi tiempo libre, ¡me encanta correr, caminar por la montaña y hacer clases de baile!";
		...
		csTxt = "<b>CENTRALESUPÉLEC (Former Centrale Paris)</b><br><br>After two years of <i>classes préparatoires MPSI/MP</i> (intensive course in mathematics and physics), I entered the <i>École Centrale Paris</i>, where I graduated in general engineering - Computer Science option. <br>The main disciplines I followed were: Information systems, Software development, Digital networks and communications, Marketing and strategy, Ethics and responsibility, Sustainable development.";
		pucTxt = "<b>PONTIFICIA UNIVERSIDADE CATÓLICA DO RIO DE JANEIRO (PUC-Rio)</b><br><br>During a year and a half, I did a Double Degree in Computer Science (courses taken in portuguese). <br>The main disciplines I followed were: Concurrent computing and parallelism, Databases, Operating systems, Data structures, Introduction to Data Sciente, Big Data and streaming, Tests and software measurements. <br> Also, I had the pleasure of receiving, for two semesters, a prize given by PUC-Rio to students with the best academic results.<br><br>During my spare time, I also participated in groups to: <br> - A 3h SQL marathon (SBBD 2019), getting 2nd place <br> - A 4h programming marathon (VTEX marathon)";
		// Experiences
		alkuDescription = "<b>E-commerce Developer</b><br>february-july 2017, Quito";
		numberlyDescription = "<b>Project Manager</b><br>august 2017-january 2018, London";
		pdrDescription = "<b>Data Analyst</b><br>february-june 2018, Barcelona";
		pucInfoDescription = "<b>Software Developer</b><br>april-december 2019, Rio de Janeiro";
		alkuTxt = "<br><b>ALKUPETS</b><br><i>E-commerce Developer (internship)</i><br><br>ALKU is a social start-up based in Ecuador which produces natural treats for dogs and handmade recycled toys, which are all environmentally friendly and help local communities.<br>With another 4 students, we developed an e-commerce platform for the company be more visible and spent 1 month in Quito to finish the project and train the local teams.";
		...
		csTxt = "<b>CENTRALESUPÉLEC (Antiga Centrale Paris)</b><br><br>Após dois anos de <i>classes préparatoires MPSI/MP</i> (curso intensivo de matemática e física), entrei na École Centrale Paris, onde me formei em engenharia da computação. <br> As principais disciplinas que fiz foram: Sistemas da informação, Desenvolvimento de software, Redes e comunicações digitais, Estratégia e marketing, Ética e responsabilidade, Desenvolvimento sustentável.";
		pucTxt = "<b>PONTIFICIA UNIVERSIDADE CATÓLICA DO RIO DE JANEIRO (PUC-Rio)</b><br><br>Durante um ano e meio, fiz um duplo diploma em engenharia da computação. <br> As principais disciplinas que fiz foram: Concorrência e paralelismo, Bancos de dados, Sistemas operacionais, Estruturas de dados, Introdução à Data Sciente, Big Data e streaming, Testes e medidas de software. <br>Também, tive o prazer de receber durante dois semestres a Bolsa Prêmio da PUC-Rio pelo mérito acadêmico.<br><br>Durante meu tempo livre, também participei em grupos a: <br> - Uma maratona de SQL de 3h (SBBD 2019), ficando em 2º lugar <br> - Uma maratona de programação de 4h (maratona VTEX)";
		// Experiences
		alkuDescription = "<b>E-commerce Developer</b><br>fevereiro-julho 2017, Quito";
		numberlyDescription = "<b>Project Manager</b><br>agosto 2017-janeiro 2018, Londres";
		pdrDescription = "<b>Data Analyst</b><br>fevereiro-junho 2018, Barcelona";
		pucInfoDescription = "<b>Software Developer</b><br>abril-dezembro 2019, Rio de Janeiro";
		alkuTxt = "<br><b>ALKUPETS</b><br><i>E-commerce Developer (estágio)</i><br><br>ALKU é uma startup social no Equador que produz à mão brinquedos reciclados e tratamentos naturais para cães, tudo respeitando o meio ambiente e ajudando às comunidades locais. <br> <br> Com outros 4 alunos, desenvolvemos uma plataforma de e-commerce para tornar a empresa mais visivel e passamos 1 mês em Quito para concluir o projeto e treinar a equipe.";
		...
		// Interests
		socialTxt = "<b>IMPACTO SOCIAL E VOLUNTARIADO </b> <br> <br>Realmente acredito que algumas pessoas motivadas podem ter um grande impacto em nossa sociedade e também na importância de pequenas ações diárias. <br> <br> Então, quando posso, tento dedicar parte do meu tempo a projetos de voluntariado: <br> * Por dois anos na universidade, fui presidenta da associação de inclusão social <i> Centrale Égalité des Chances </i>(agora OSER)</i> <br> * Também ensinei matemática e espanhol para jovens imigrantes em Barcelona (2018) e na Associação Parque Vivo do Rio de Janeiro (2019)";
